...
<head>
  ...
  <!-- <link rel="stylesheet" href="<?= base_url()?>/templates/node_modules/bootstap/dist/css/bootstrap.min.css"> -->
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block"><?= session('user_nama'); ?></div></a>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?= site_url('/'); ?>">BKAD</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html">Keu</a>
          </div>
          <ul class="sidebar-menu">
            <?= $this->include('layout/menuside'); ?>
          </ul>
        </aside>
      </div>
      <!-- Main Content -->
